...
public class DonorRegistration {
    ...
    public DonorRegistration(int user_id, String blood_group, String location, String city, String state,
            String phone) {
    ...
    public String getAlcohol_consumer() {
        return alcohol_consumer;
    }

    public void setAlcohol_consumer(String alcohol_consumer) {
        this.alcohol_consumer = alcohol_consumer;
    }
